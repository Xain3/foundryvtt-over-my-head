/**
 * @file placeableGetter.unit.test.js
 * @description Unit tests for PlaceableGetter helper.
 * @path src/handlers/placeableHelpers/placeableGetter.unit.test.js
 */
...
describe('PlaceableGetter', () => {
    ...
    describe('getCorner', () => {
      ...
      it('should log a warning for an unknown corner', () => {
            ...
            expect(mockUtils.logger.warn).toHaveBeenCalledWith(expect.stringContaining('unknownCorner'));
        }
        );
    ...
    it('should log a warning if corner is null', () => {
            ...
            expect(corner).toBeNull();
            expect(mockUtils.logger.warn).toHaveBeenCalledWith('No corner provided. Returning null.');
        });
    ...
    it('should log a warning and call getCenter if "center" is provided', () => {
            ...
            expect(mockUtils.logger.warn).toHaveBeenCalledWith('getCorner is used to get corners only. Use getCenter for center.');
        }
        );
    });
    ...
    describe('getPosition', () => {
        it('should return the center when "use" is set to "center"', () => {
            const position = placeableGetter.getPosition(mockPlaceable, placeableGetter, 'center');
        ...
        it('should return undefined for unhandled "use" values', () => {
            const position = placeableGetter.getPosition(mockPlaceable, placeableGetter, 'unknown');

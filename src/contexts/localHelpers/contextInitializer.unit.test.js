...
describe('ContextInitializer', () => {
    ...
    describe('initializeContext', () => {
        ...
        let initializeDataSpy;
        let initializeFlagsSpy;
        let validateInitialStateSpy;

        beforeEach(() => {
            initializeDataSpy = jest.spyOn(ContextInitializer, 'initializeData');
            initializeFlagsSpy = jest.spyOn(ContextInitializer, 'initializeFlags');
        ...
        it('should use provided initialData if it is a valid object', () => {
            ...
            expect(initializeDataSpy).toHaveBeenCalledWith(ctx, customData.data);
            expect(initializeFlagsSpy).toHaveBeenCalledWith(ctx, customData.flags);
        ...
        it('should use ctx.initialState if initialData is null', () => {
            ...
            expect(initializeDataSpy).toHaveBeenCalledWith(ctx, mockInitialState.data);
            expect(initializeFlagsSpy).toHaveBeenCalledWith(ctx, mockInitialState.flags);
        ...
        it('should use validated empty object if initialData and ctx.initialState are invalid', () => {
            ...
            expect(initializeDataSpy).toHaveBeenCalledWith(ctx, undefined); // Called with undefined data from validated state
            expect(initializeFlagsSpy).toHaveBeenCalledWith(ctx, undefined); // Called with undefined flags
        });

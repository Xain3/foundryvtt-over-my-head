...
class ViteRunner {
  /**
   * @param {Function|string} [preBuildAction=null] - Action to run before starting Vite. Can be a function, .sh script path, or .js module path.
   * @param {Function|string} [postBuildAction=null] - Action to run after each build. Can be a function, .sh script path, or .js module path.
   */

...
describe('ModuleDeployer', () => {
  ...
  describe('deploy', () => {
    ...
    it('should sync all TO_DEPLOY items successfully', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Syncing TO_DEPLOY items to /target/dir');
  ...
  describe('integration scenarios', () => {
    ...
    it('should handle typical FoundryVTT module deployment', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Syncing TO_DEPLOY items to /foundry/modules/test-module');

 ...
 * @property {Record<string, unknown>} constants - Merged YAML constants from constant files (fixed values)
 * @property {Record<string, unknown>} configs - Merged YAML configs from config files (behavioral settings)
